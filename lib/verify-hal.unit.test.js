    ...
    describe("_links", () => {
        it("should fail when no '_links'", () => {
            ...
            expect(() => moduleToTest(expect, data))
                .to.throw(chai.AssertionError, /expected {} to have a property '_links'/);
        });
        ...
        it("should fail if _link doesn't have 'self'", () => {
            ...
            expect(() => moduleToTest(expect, data))
                .to.throw(chai.AssertionError, /expected {} to have a property 'self'/);
        });
        ...
        it("should fail if a link doesn't have 'href'", () => {
            ...
            expect(() => moduleToTest(expect, data))
                .to.throw(chai.AssertionError, /expected {} to have a property 'href'/);
        });
